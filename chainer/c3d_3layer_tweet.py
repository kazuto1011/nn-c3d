...
api = twitter.Api(consumer_key=twitkey.twkey['cons_key'],
...
for epoch in six.moves.range(1, n_epoch + 1):
    ...
    postmsg += 'train: %1.4f, '%(sum_accuracy/N)
    ...
    postmsg += 'test: %1.4f'%(sum_accuracy/N_test)
...
api.PostUpdate(('finished training').decode('utf-8'))
